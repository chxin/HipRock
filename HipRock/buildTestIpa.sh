...
# read version
# done
version=`/usr/libexec/PlistBuddy -c "Print :CFBundleShortVersionString" ./ios/HipRock/Info.plist`
...
curl -F "file=@$OUTPUTDIR/$APPNAME/$SCHEMETEST.ipa" -F 'uKey=7d42c69844b88157360fe2dc141fdf1a' -F '_api_key=be1290e71bb2fab7a9547cda2ee37d7b' -F "installType=2" -F "password=123456" -F "updateDescription=$description" 'https://www.pgyer.com/apiv1/app/upload'
