...
{
    NSString* defaultImgPath = [[NSBundle mainBundle]pathForResource:@"DefaultBuilding" ofType:@"png"];
    self.defaultImage = [UIImage imageWithContentsOfFile:defaultImgPath];
