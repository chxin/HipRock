...
-(UIView *)renderCloseView
{
    ...
    CGFloat topOffset = (kDMChart_TooltipViewHeight - REMIMG_TooltipClose.size.height) / 2;
    CGFloat leftOffset = kDMChart_TooltipCloseViewInnerLeftOffset;
    
    UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
    [button setFrame:CGRectMake(leftOffset, topOffset, REMIMG_TooltipClose.size.width, REMIMG_TooltipClose.size.height)];
