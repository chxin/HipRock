...
//        graph.backgroundColor = [UIColor greenColor].CGColor;
    ...
    self.legendView = [[UIView alloc]initWithFrame:CGRectMake(0, frame.size.height - kBuildingTrendChartLegendHeight + 18, frame.size.width, kBuildingTrendChartLegendHeight)];
