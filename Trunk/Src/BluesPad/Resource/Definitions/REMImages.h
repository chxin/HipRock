...
//images in /:
#define REMIMG_Default REMLoadImageNamed(@"Default")
...
#define REMIMG_WeiboBana REMLoadImageNamed(@"WeiboBana")
...
#define REMIMG_mail REMLoadImageNamed(@"mail")
...
#define REMIMG_weibo REMLoadImageNamed(@"weibo")
...
#define REMIMG_Propaganda_1 REMLoadImageNamed(@"Propaganda_1")
#define REMIMG_Propaganda_2 REMLoadImageNamed(@"Propaganda_2")
#define REMIMG_Propaganda_3 REMLoadImageNamed(@"Propaganda_3")
