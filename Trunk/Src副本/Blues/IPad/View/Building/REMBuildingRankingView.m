...
- (void)initTextLabel:(REMRankingDataModel *)data withSize:(CGFloat)titleSize withTitleMargin:(CGFloat)margin withLeftMargin:(CGFloat)leftMargin
{
    ...
    CGSize expectedLabelSize = [rankingLabel.text sizeWithFont:[REMFont numberLabelFontOfSize:kBuildingCommodityDetailValueFontSize]];
    ...
    self.totalLabel.font=[REMFont numberLabelFontOfSize:kBuildingCommodityDetailUomFontSize];
