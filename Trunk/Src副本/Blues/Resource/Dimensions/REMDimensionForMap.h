...
#define kDMGallery_GalleryTableViewFrame CGRectMake(kDMCommon_ContentLeftMargin, REMDMCOMPATIOS7(kDMGallery_GalleryGroupViewTopOffset), kDMGallery_GalleryGroupViewWidth, kDMGallery_GalleryGroupViewHeight)
