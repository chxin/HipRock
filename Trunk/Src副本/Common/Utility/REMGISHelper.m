...
@implementation REMGISHelper

+(CLLocationCoordinate2D)transformFromGCJToWGS:(CLLocationCoordinate2D)gcjLoc
{
    CLLocationCoordinate2D marsLocation = [REMGISHelper transformFromWGSToGCJ:gcjLoc];
    CLLocationDegrees delta_lat = marsLocation.latitude - gcjLoc.latitude;
    CLLocationDegrees delta_lng = marsLocation.longitude - gcjLoc.longitude;
    return CLLocationCoordinate2DMake(gcjLoc.latitude-delta_lat, gcjLoc.longitude-delta_lng);
}
