...
//  LineChartDemo
//
//  Created by TanTan on 6/8/13.
//  Copyright (c) 2013 TanTan. All rights reserved.
//

#import "REMChartViewController.h"
#import "REMEnergyData.h"


@interface REMChartViewController ()
@property (nonatomic,retain) REMEnergyData *data;
@property (nonatomic,retain) NSMutableArray *colors;
@end

@implementation REMChartViewController
...
- (void) initLineChart
{
    ...
    graph.plotAreaFrame.paddingBottom=10.0f;
...
-(void)setTickPosition: (CPTAxis *)xAxis
{
    ...
    for (int i=1;i<series.data.count;i+=3) {
